...
public class MovieInfo implements java.io.Serializable {
	...
	public MovieInfo(String movieName, String movieDirector, String movieActor,
			...
			Date moviePublishDate, String movieIntroduction, String movieShowOn) {
	...
	public MovieInfo(String movieName, String movieDirector, String movieActor,
			...
			String movieContentPicture, String movieShowOn, Set movieShowInfos,
			Set movieViewInfos, Set movieTypes, Set payInfos) {
		this.movieName = movieName;
		this.movieDirector = movieDirector;
		this.movieActor = movieActor;
		this.movieType = movieType;
	...
	public String getMovieShowOn() {
		return this.movieShowOn;
	}

	public void setMovieShowOn(String movieShowOn) {
		this.movieShowOn = movieShowOn;
	}

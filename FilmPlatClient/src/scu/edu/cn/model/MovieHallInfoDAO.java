 ...
 * 
 * @see scu.edu.cn.model.MovieHallInfo
...
public class MovieHallInfoDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String MOVIE_HAIL_NAME = "movieHailName";
	...
	public MovieHallInfo findById(java.lang.Integer id) {
		...
		try {
			MovieHallInfo instance = (MovieHallInfo) getSession().get(
					"scu.edu.cn.model.MovieHallInfo", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(MovieHallInfo instance) {
		...
		try {
			List results = getSession().createCriteria(
					"scu.edu.cn.model.MovieHallInfo").add(
	...
	public List findByMovieHailName(Object movieHailName) {
		return findByProperty(MOVIE_HAIL_NAME, movieHailName);
	}

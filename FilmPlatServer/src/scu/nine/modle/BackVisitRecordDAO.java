 ...
 * 
 * @see scu.nine.modle.BackVisitRecord
	...
	public List findByExample(BackVisitRecord instance) {
		...
		try {
			List results = getSession().createCriteria(
					"scu.nine.modle.BackVisitRecord").add(
